                                ...
                                <ul class="shop-sidebar-product">
                                    <li>
                                        <div class="side-pro-img">
                                            <a href="product-details.html"><img src="~assets/img/product/latest/shop-rsp1.jpg" alt=""></a>
                                        </div>
                                    ...
                                    <li>
                                        <div class="side-pro-img">
                                            <a href="product-details.html"><img src="~assets/img/product/latest/shop-rsp3.jpg" alt=""></a>
                                        </div>
                                        <div class="side-pro-content">
                                            <div class="side-pro-rating">
                                                <i class="fas fa-star"></i>
                                    ...
                                    <li>
                                        <div class="side-pro-img">
                                            <a href="product-details.html"><img src="~assets/img/product/latest/shop-rsp2.jpg" alt=""></a>
                                        </div>
                                        <div class="side-pro-content">
                                            <div class="side-pro-rating">
                                                <i class="fas fa-star"></i>
                                    ...
                                    <li>
                                        <div class="side-pro-img">
                                            <a href="product-details.html"><img src="~assets/img/product/latest/shop-rsp4.jpg" alt=""></a>
                                        </div>
                                        <div class="side-pro-content">
                                            <div class="side-pro-rating">
                                                <i class="fas fa-star"></i>
